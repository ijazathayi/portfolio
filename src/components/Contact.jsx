...
import img3 from '../assets/address.svg'
  ...
  return (
    <div id='contactme'>
      <div id="contactcmd">
        ...
        <div className="contactinp-div">name: <input type="text" name="" className='contactinp' id="contactinp-1" /></div>
        <div className="contactinp-div">email: <input type="text" name="" className='contactinp' id="contactinp-2" /></div>
        <div className="contactinp-div">comment: <textarea name="" className='contactinp' id="contactinp-3" ></textarea></div>
        <div className="contactinp-div"> <button id="contactinp-4" className='contactinp'>submit</button>  </div>
      </div>
      <div id="contactinf">
        <p>Get in touch</p>
